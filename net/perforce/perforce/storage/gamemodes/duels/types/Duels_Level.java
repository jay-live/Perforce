...
public class Duels_Level {
    ...
    public Duels_Level(String uuid, int level, int experience) {
        this.uuid = uuid;
        this.level = level;
    ...
    public int getExperience() {
        return (int) MongoDB.getDataDocument("experience", uuid, collection);
    }

    public void setExperience(int experience) {
        this.experience = experience;
        MongoDB.setDataDocument(experience, "experience", uuid, collection);
    }

    public int getLevel() {
        return (int) MongoDB.getDataDocument("level", uuid, collection);
    }

    public void setLevel(int level) {
        this.level = level;
        MongoDB.setDataDocument(level, "level", uuid, collection);
    }
